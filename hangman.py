...
def increment_failed_attempts(attempts):
...
def main():
    ...
    # The loop - as long as the entire word is not completed
    # and we have not reached the maximum number of attempts
    while attempts < NUMBER_OF_ATTEMPTS and "_" in the_hidden_word:
        ...
        # Checks whether the entered character has not already been entered
            ...
            if update_of_the_hidden_word_by_letter(the_word, the_hidden_word, letter):
                ...
                attempts = increment_failed_attempts(attempts)
